...
export default function CoverLetterEditorPage() {
  ...
  const saveCurrentLetterRef = useRef(saveCurrentLetter);
  saveCurrentLetterRef.current = saveCurrentLetter;
  const isDirtyRef = useRef(isDirty);
  isDirtyRef.current = isDirty;  const loadLetter = useCoverLetterStore((s) => s.loadLetter);
  ...
  const handleExport = async (format: ExportFormat) => {
    // Save before export to ensure latest data is exported
    if (isDirty) {
